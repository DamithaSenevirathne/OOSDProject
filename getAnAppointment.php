      ...
      <br><br><br>
        ...
        <?php if(isset($_SESSION['ID'])) : ?>
            <div class="jumbotron">
                ...
                <h3>You are an internal patient</h3>
                <a href="doctors.php" class="btn btn-primary">View Doctors list</a>
        ...
        <?php else : ?>
          ...
          <div class="jumbotron-custom" >
            ...
            <div class="jumbotron text-center">
                ...
                <p>Already have an account then please Login to proceed</p>
                <p>Still don't have account ? then please Signup to proceed</p>
                <a href="patientlogin.php" class="btn btn-primary">Log In</a>
                <a href="patientsignup.php" class="btn btn-primary">Sign Up</a>
                <p> </p>
                <p>or</p>
                <p>Want to know more about our doctors?</p>
                <a href="doctors.php" class="btn btn-danger">view doctors</a>
