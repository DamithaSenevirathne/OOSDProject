      ...
      <br><br><br>
        ...
        <div class="login-page">
          <div class="form">
            ...
            <input type="text" name = 'sex' placeholder="Enter Your Gender (Male/Female)"/>
            <input type="text" name = 'bday' placeholder="Enter Your Birth day YYYY-MM-DD"/>
            ...
            <p class="message">Already have an account? <a href="patientlogin.php">Log In</a></p>
            </form>
          </div>
        </div>      
